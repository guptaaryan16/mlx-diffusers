...
def rename_key_and_reshape_tensor(pt_tuple_key, pt_tensor, random_mlx_state_dict):
...
def convert_pytorch_state_dict_to_mlx(pt_state_dict, flax_model, init_key=42):
